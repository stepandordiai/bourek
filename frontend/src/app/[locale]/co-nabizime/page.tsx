...
export async function generateMetadata({
	...
	const t = await getTranslations({ locale, namespace: "offer.meta" });
...
export default async function Offer() {
	...
	return (
		<main className="offer">
			<Breadcrumbs title={t("offer_title")} />
			<Container>
				<div className="offer-container">
						...
						<li>
							...
							<ul className="offer-list">
								...
								<li>
									...
									aparátu, bolesti hlavy, psychosomatické obtíže, doplňkově
									obrna lícního nervu, doplňkově neuralgie trigeminu, ...),
								</li>
							</ul>
						</li>
					</ul>
					<p>
						Akupunktura v ČR není hrazena z veřejného zdravotního pojištění, viz
						ceník
					</p>
					<p>
					...
					<p>
						<strong>Fyzioterapie:</strong> <i>Iva Matějková, Radka Jansová</i>
					</p>
					<p>
						Kompletní elektroléčba, laser terapie (obojí na přístrojích české
						firmy BTL, s. r. o.), solux, léčebná tělesná výchova, speciální LTV
						na míčích, poradenství o zdravém životním stylu, tj. veškeré
