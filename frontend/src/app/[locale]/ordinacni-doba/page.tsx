...
export async function generateMetadata({
	...
	const t = await getTranslations({ locale, namespace: "our_team.meta" });
	const page = "ordinacni-doba";
...
export default async function ClinicHours() {
	const t = await getTranslations();

	return (
		<main>
			<Breadcrumbs title={t("clinicHoursTitle")} />
			<Container>
