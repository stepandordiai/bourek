        ...
        <>
            ...
            <section className="home">
                ...
                <div className="home__services" id="services">
                    <h2 className="home__services-title">
                        {t("services_title")}
                    </h2>
                    ...
                    <div className="faq__item">
                        ...
                        <div className="grid-line">
                            <p>
                                ...
                                adipisicing elit. Odio, quos totam. Nihil harum
                                inventore enim reiciendis, quam voluptas
                                explicabo laborum dolorem vitae veritatis
                                asperiores repudiandae ipsam eveniet dolor
                                ipsum. Voluptates.
                            </p>
                        </div>
                    </div>
